    ...
    <div className="p-6 space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div className="bg-gray-900 rounded-xl p-5 border border-gray-800">
          ...
          <p className="text-sm text-gray-400">{t('dashboard.locale_label')}: {status.locale}</p>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="bg-gray-900 rounded-xl p-5 border border-gray-800">
          ...
          <div className="space-y-4">
            {[
              { label: t('dashboard.session_label'), value: cost.session_cost_usd, color: 'bg-blue-500' },
              { label: t('dashboard.daily_label'), value: cost.daily_cost_usd, color: 'bg-green-500' },
              { label: t('dashboard.monthly_label'), value: cost.monthly_cost_usd, color: 'bg-purple-500' },
