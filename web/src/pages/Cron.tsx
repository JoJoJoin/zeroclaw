...
export default function Cron() {
  ...
  const handleAdd = async () => {
    if (!formSchedule.trim() || !formCommand.trim()) {
      setFormError(t('cron.schedule_command_required'));
      return;
    }
    setSubmitting(true);
    setFormError(null);
        ...
        <div className="fixed inset-0 bg-black/60 flex items-center justify-center z-50">
          <div className="bg-gray-900 border border-gray-700 rounded-xl p-6 w-full max-w-md mx-4">
            ...
            <div className="space-y-4">
              ...
              <div>
                <label className="block text-sm font-medium text-gray-300 mb-1">
                  {t('cron.schedule_required')} <span className="text-red-400">*</span>
                </label>
                <input
                  type="text"
                  value={formSchedule}
              ...
              <div>
                <label className="block text-sm font-medium text-gray-300 mb-1">
                  {t('cron.command_required')} <span className="text-red-400">*</span>
                </label>
                <input
                  type="text"
                  value={formCommand}
              ...
              {jobs.map((job) => (
                ...
                >
                  ...
                  <td className="px-4 py-3">
                    ...
                    >
                      {job.enabled ? t('cron.enabled') : t('cron.disable')}
                    </span>
                  </td>
